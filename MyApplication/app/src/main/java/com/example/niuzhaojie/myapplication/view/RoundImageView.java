...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.RoundeImageView);
        mBorderThickness = a.getDimensionPixelSize(R.styleable.RoundeImageView_border_thickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.RoundeImageView_border_outside_color, defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.RoundeImageView_border_inside_color, defaultColor);
    }
