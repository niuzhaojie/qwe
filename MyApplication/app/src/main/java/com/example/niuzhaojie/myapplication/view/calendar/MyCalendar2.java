...
public class MyCalendar2 extends LinearLayout {
    ...
    public MyCalendar2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.gridview_calendar2, parent, false));
        }
